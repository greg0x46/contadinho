...
-- (via a rule's 'reconcile' action, see 00015_automation_rule_actions.sql) —
...
-- recurring_commitment_conditions). Rebuilt via copy-swap rather than
-- ALTER TABLE ... DROP CONSTRAINT to avoid depending on Postgres's
