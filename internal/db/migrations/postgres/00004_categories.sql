...
DROP TRIGGER transaction_category_events_reject_delete ON transaction_category_events;
DROP TRIGGER transaction_category_events_reject_update ON transaction_category_events;
